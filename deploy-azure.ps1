...
Write-Host ""
Write-Host "  1. Register the OAuth credential in M365 Copilot Admin:"
Write-Host "       https://admin.microsoft.com  > Settings > Copilot > Plugin management"
Write-Host "       Click 'Add OAuth credential'  and enter:"
Write-Host "         Client ID     : $clientId"
Write-Host "         Client secret : $clientSecret"
Write-Host "         Token URL     : https://login.microsoftonline.com/$tenantId/oauth2/v2.0/token"
Write-Host "         Scope         : api://$appRegName/.default"
Write-Host "       Copy the 'Vault reference ID' shown after saving."
Write-Host ""
Write-Host "  2. Open manifest.json and replace the two placeholders:"
Write-Host "       mcpServerUrl        -> $mcpUrl"
Write-Host "       oAuthPluginVaultId  -> <vault reference ID from step 1>"
Write-Host ""
Write-Host "  3. Run .\package.ps1 to repackage the ZIP."
Write-Host "  4. Re-upload d365fo-cowork-plugin.zip to Cowork."
Write-Host ""
